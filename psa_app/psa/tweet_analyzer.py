...
def analyze_stats():
    ...
    '''
    Analyzes the stats for the whole data set.
    :return:
    '''
...
def analyze_topics():
    ...
    '''
    Analyzed the topics in the dataset, and creates a topic distribution for each tweet
    '''
    ...
    # Prepare the text for LDA and create tokens
    ...
    # Create the corpus with a Bag of Words representation
    ...
    # Create the model by specifying the number of topics
    ...
    # Generate topics for the data set.
    ...
    # Generate topics for all the tweets in the data set and save to DB.
